...
<section>
    <div class="mb-5">
        ...
        <div class="main_title ">
                                <h1 class="page-title" id="title">Tous les restaurants de la ville de Lubumbashi</h1>
                            </div><br>
            ...
            <div class="col-md-3">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div classs="card-body">
                                ...
                                <ul clss="list-unstyled">
                                    <a href="#">
                                        <li>restaurant 5 etoiles</li>
                                    </a>
                                    <a href="#">
                                        <li>restaurant 4 etoiles</li>
                                    </a>
                                    <a href="#">
                                        <li>restaurant 3 etoiles</li>
                                    </a>
                                    <a href="#">
                                        <li>restaurant 2 etoiles</li>
                                    </a>
                                    <a href="#">
                                        <li>Fast Food</li>
                                    </a>
                ...
                <div class="mb-3">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <strong><p>Localisation</p></strong>
                                <ul class="list-unstyled">
                                    <a href="#">
                                        <li>Centre ville</li>
                                    </a>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        <h5>MIGA GELATO</h5>
                                        <small>Golf Inc., Lubumbashi</small>
                                        <p><small>11907 Dyuuleves Incorpotatestion, South west, Newzealer</small></p>
                                    </div>
                                    <div class="col-md-2">
                                        <button type="button" class="btn btn-outline bg-orange">Voir Menu</button>
                                        <small>Publie en Nov 27, 2017</small>
                                    </div>
                                </div>
